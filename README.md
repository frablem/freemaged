...
- **v2.3:** Square controls and matching angular icons, a true-black OLED dark theme, neutral light colors, compact tool navigation, a locally embedded Anton wordmark, and simpler visual hierarchy across the editor and About page.
